    ...
    ingredientes: [                          /* arreglo de ingredientes */
                    {
                      ...
                      precio: 1.20                         /* precio de 1000 g = $1.20 */
                    },
                    {
...
function calcularCostoIngrediente(ingrediente) {
  ...
  /* Calculamos el precio por unidad mínima (por gramo, por ml, etc.)
     dividiendo el precio total entre la cantidad por la que aplica */
  let precioPorUnidad = ingrediente.precio / ingrediente.precioPor;
  /* Ejemplo: $1.20 ÷ 1000 g = $0.0012 por gramo */
 
  /* Multiplicamos el precio por unidad por la cantidad usada en la receta */
  let costoTotal = precioPorUnidad * ingrediente.cantidad;
  /* Ejemplo: $0.0012 × 500 g = $0.60 */
 
  /* parseFloat convierte el número a decimal.
     toFixed(2) redondea a exactamente 2 decimales.
     Ejemplo: 0.6000000001 se convierte en 0.60 */
...
function mostrarIngredientes(producto) {
  ...
  /* Inyectamos todo el HTML construido dentro del contenedor */
  contenedorIngredientes.innerHTML = html;
 
  /* Calculamos el costo por porción dividiendo el total entre el número de porciones */
  costoPorPorcion = costoTotalReceta / producto.porciones;
